...
export function PersonalStats() {
  ...
  const role = String((user?.role || (user as any)?.roleName || ''))
  ...
  // Original Logic (Commented out effectively by not being used in the main return, but kept for reference if needed)
  /*
  const { data, isLoading: queryLoading, isError, error: queryError } = useUserAnalytics(
    currentUserId || '', 
